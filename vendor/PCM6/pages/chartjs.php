...
<body>
  ...
  $lastYears = range($toYear, $currentYear);

  // Finding year wise complaints
  $lastYearsData = array(5, 10, 15, 20, 16, 60);
  ?>
  <script>
    $(function() {
      /* ChartJS
      ...
      var data = {
        labels: [
          <?php foreach ($lastYears as $lyvalue) {
            echo $lyvalue . ",";
          } ?>
        ],
        datasets: [{
          label: "# of Complaints",
          data: [
            <?php foreach ($lastYearsData as $value) {
              echo $value . ",";
            } ?>
          ],
          backgroundColor: [
      ...
      var doughnutPieData = {
        datasets: [{
          data: [<?php echo $pending . "," . $inProgress . "," . $completed;  ?>],
          backgroundColor: [
            "rgba(255, 99, 132, 0.5)",
            "rgba(255, 206, 86, 0.5)",
            "rgba(54, 162, 235, 0.5)",
