...
<body>
  ...
  <div class="container-fluid bg-primary text-light">
    <div class="pl-5 pt-4 pb-3 d-flex flex-column">
      <h3> PCM - PC Complaint Management</h3>
      <p class="fs-6 mt-1"> This portal is used for students to register complaints about PCs, either software or hardware problems.</p>
    </div>
  </div>
  ...
  <footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
      <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Guided By : Dr. Ajay N. Upadhyaya, Piyush Patel</span>
      <span class=" text-center text-sm-left d-block d-sm-inline-block">Developed by: Shiv Patel, Javlan Patel, Gaurav Jethva, Heet Patel.</span>
    </div>
